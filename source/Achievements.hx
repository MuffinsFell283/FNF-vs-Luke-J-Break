...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Thank you for playing!",		"Beat WeekLuke Demo with no Misses.",				'weekluke_nomiss',		false],
		["Thank you for playing too!",	"Beat WeekLuke with no Misses.",					'weekluker_nomiss',		false],
		["They are friends...?",		"Beat \"Ecstasy\" on Hard with no Misses.",					'cover_nomiss',			false],
